# Create a program to check your Twitter friends, store them, then periodicly spider out through your friends list. Data is stored in a database, counts for each time a friend is encountered are stored to indicate populartiry.
